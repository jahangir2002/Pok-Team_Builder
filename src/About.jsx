    ...
    <>
      <section className="max-w-screen-xl px-5 md:px-0 m-auto py-5">
        ...
        <div className="md:px-5 pb-10">
          ...
          />, but I also enjoy experimenting with animation libraries like <TooltipItem
